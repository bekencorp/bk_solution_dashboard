...
- Use the :strong:`USB-UART` interface for BK3515NS flashing. Switch the jumpers as listed above and
  disconnect the flashing connection when finished.

- Use the board's :strong:`USB` interface for MTP. After connecting to a PC, run ``ap_cmd mtp start``
