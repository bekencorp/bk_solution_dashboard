# Scooter Dashboard V1.0 1280×720 使用说明

* [English](./README.md)

## 开发板使用说明

本说明适用于 1280×720 横屏界面的 Dashboard V1.0 硬件，对应工程 `scooter_dashboard_v1_1280_720`。
...
| --- | --- |
| 主控 | BK7259 |
| 蓝牙从控 | BK3515NS，通过 UART1 与 BK7259 通信 |
...
上电并播放开机动画后，默认进入 1280×720 仪表主页。页面自动演示：
