...
void init_page_dashcam(bk_lv_ui_t *bk_ui)
{
    ...
    lv_obj_set_size(bk_ui->dashcam, 1024, 600);
    ...
    lv_obj_set_width(bk_ui->dashcam_bg_img, 1024);
    lv_obj_set_height(bk_ui->dashcam_bg_img, 600);
    ...
    lv_obj_set_x(bk_ui->dashcam_bottom_bar, 19);
    lv_obj_set_y(bk_ui->dashcam_bottom_bar, 553);
    lv_obj_set_width(bk_ui->dashcam_bottom_bar, 776);
    lv_obj_set_height(bk_ui->dashcam_bottom_bar, 27);
    ...
    lv_obj_set_style_bg_color(bk_ui->dashcam_bottom_bar, lv_color_hex(0xffffff), LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(bk_ui->dashcam_bottom_bar, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(bk_ui->dashcam_bottom_bar, LV_GRAD_DIR_NONE, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(bk_ui->dashcam_bottom_bar, lv_color_hex(0xffffff), LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(bk_ui->dashcam_bottom_bar, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(bk_ui->dashcam_bottom_bar, 255, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(bk_ui->dashcam_bottom_bar, LV_BORDER_SIDE_FULL, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(bk_ui->dashcam_bottom_bar, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(bk_ui->dashcam_bottom_bar, false, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);

    bk_ui->dashcam_ctrl_info_row = lv_obj_create(bk_ui->dashcam_bottom_bar);
    lv_obj_set_x(bk_ui->dashcam_ctrl_info_row, 14);
    lv_obj_set_y(bk_ui->dashcam_ctrl_info_row, 3);
    lv_obj_set_width(bk_ui->dashcam_ctrl_info_row, 747);
    lv_obj_set_height(bk_ui->dashcam_ctrl_info_row, 20);
    ...
    lv_obj_set_style_bg_color(bk_ui->dashcam_ctrl_info_row, lv_color_hex(0xffffff), LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(bk_ui->dashcam_ctrl_info_row, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(bk_ui->dashcam_ctrl_info_row, LV_GRAD_DIR_NONE, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(bk_ui->dashcam_ctrl_info_row, lv_color_hex(0xffffff), LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(bk_ui->dashcam_ctrl_info_row, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(bk_ui->dashcam_ctrl_info_row, 255, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(bk_ui->dashcam_ctrl_info_row, LV_BORDER_SIDE_FULL, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(bk_ui->dashcam_ctrl_info_row, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(bk_ui->dashcam_ctrl_info_row, false, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(bk_ui->dashcam_dur_start, 50);
    lv_obj_set_height(bk_ui->dashcam_dur_start, 17);
    ...
    lv_obj_set_x(bk_ui->dashcam_dur_end, 697);
    lv_obj_set_y(bk_ui->dashcam_dur_end, 2);
    lv_obj_set_width(bk_ui->dashcam_dur_end, 50);
    lv_obj_set_height(bk_ui->dashcam_dur_end, 17);
    ...
    lv_obj_set_x(bk_ui->dashcam_time_bar, 54);
    lv_obj_set_y(bk_ui->dashcam_time_bar, 6);
    lv_obj_set_width(bk_ui->dashcam_time_bar, 638);
    lv_obj_set_height(bk_ui->dashcam_time_bar, 8);
    lv_obj_set_style_anim_duration(bk_ui->dashcam_time_bar, 1000, 0);
    ...
    lv_obj_set_x(bk_ui->dashcam_front_vid_panel, 19);
    lv_obj_set_y(bk_ui->dashcam_front_vid_panel, 21);
    lv_obj_set_width(bk_ui->dashcam_front_vid_panel, 776);
    lv_obj_set_height(bk_ui->dashcam_front_vid_panel, 520);
    ...
    lv_obj_set_style_bg_color(bk_ui->dashcam_front_vid_panel, lv_color_hex(0xffffff), LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(bk_ui->dashcam_front_vid_panel, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(bk_ui->dashcam_front_vid_panel, LV_GRAD_DIR_NONE, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(bk_ui->dashcam_front_vid_panel, lv_color_hex(0xffffff), LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(bk_ui->dashcam_front_vid_panel, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(bk_ui->dashcam_front_vid_panel, 255, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(bk_ui->dashcam_front_vid_panel, LV_BORDER_SIDE_FULL, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(bk_ui->dashcam_front_vid_panel, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(bk_ui->dashcam_front_vid_panel, false, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);

    bk_ui->dashcam_info_bar = lv_obj_create(bk_ui->dashcam_front_vid_panel);
    lv_obj_set_x(bk_ui->dashcam_info_bar, 4);
    lv_obj_set_y(bk_ui->dashcam_info_bar, 480);
    lv_obj_set_width(bk_ui->dashcam_info_bar, 768);
    lv_obj_set_height(bk_ui->dashcam_info_bar, 34);
    ...
    lv_obj_set_style_bg_color(bk_ui->dashcam_info_bar, lv_color_hex(0xffffff), LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(bk_ui->dashcam_info_bar, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(bk_ui->dashcam_info_bar, LV_GRAD_DIR_NONE, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(bk_ui->dashcam_info_bar, lv_color_hex(0xffffff), LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(bk_ui->dashcam_info_bar, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(bk_ui->dashcam_info_bar, 255, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(bk_ui->dashcam_info_bar, LV_BORDER_SIDE_FULL, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(bk_ui->dashcam_info_bar, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(bk_ui->dashcam_info_bar, false, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);

    bk_ui->dashcam_sky_area = lv_obj_create(bk_ui->dashcam_front_vid_panel);
    lv_obj_set_x(bk_ui->dashcam_sky_area, 4);
    lv_obj_set_y(bk_ui->dashcam_sky_area, 28);
    lv_obj_set_width(bk_ui->dashcam_sky_area, 768);
    lv_obj_set_height(bk_ui->dashcam_sky_area, 450);
    ...
    lv_obj_set_style_bg_color(bk_ui->dashcam_sky_area, lv_color_hex(0xffffff), LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(bk_ui->dashcam_sky_area, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(bk_ui->dashcam_sky_area, LV_GRAD_DIR_NONE, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(bk_ui->dashcam_sky_area, lv_color_hex(0xffffff), LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(bk_ui->dashcam_sky_area, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(bk_ui->dashcam_sky_area, 255, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(bk_ui->dashcam_sky_area, LV_BORDER_SIDE_FULL, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(bk_ui->dashcam_sky_area, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(bk_ui->dashcam_sky_area, false, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->dashcam_front_tag, 14);
    lv_obj_set_y(bk_ui->dashcam_front_tag, 10);
    lv_obj_set_width(bk_ui->dashcam_front_tag, 80);
    lv_obj_set_height(bk_ui->dashcam_front_tag, 20);
    ...
    lv_obj_set_style_text_font(bk_ui->dashcam_front_tag, &lv_font_montserrat_regular_12, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->dashcam_ts_overlay, 292);
    lv_obj_set_y(bk_ui->dashcam_ts_overlay, 490);
    lv_obj_set_width(bk_ui->dashcam_ts_overlay, 192);
    lv_obj_set_height(bk_ui->dashcam_ts_overlay, 20);
    ...
    lv_obj_set_style_text_font(bk_ui->dashcam_ts_overlay, &lv_font_montserrat_regular_12, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->dashcam_spd_overlay, 651);
    lv_obj_set_y(bk_ui->dashcam_spd_overlay, 488);
    lv_obj_set_width(bk_ui->dashcam_spd_overlay, 110);
    lv_obj_set_height(bk_ui->dashcam_spd_overlay, 20);
    ...
    lv_obj_set_style_text_font(bk_ui->dashcam_spd_overlay, &lv_font_montserrat_regular_16, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->dashcam_file_name, 14);
    lv_obj_set_y(bk_ui->dashcam_file_name, 489);
    lv_obj_set_width(bk_ui->dashcam_file_name, 256);
    lv_obj_set_height(bk_ui->dashcam_file_name, 20);
    ...
    lv_obj_set_style_text_font(bk_ui->dashcam_file_name, &lv_font_montserrat_regular_14, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->dashcam_Live, 682);
    lv_obj_set_y(bk_ui->dashcam_Live, 10);
    lv_obj_set_width(bk_ui->dashcam_Live, 80);
    lv_obj_set_height(bk_ui->dashcam_Live, 20);
    ...
    lv_obj_set_style_text_font(bk_ui->dashcam_Live, &lv_font_montserrat_regular_12, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->dashcam_rec_list_panel, 807);
    lv_obj_set_y(bk_ui->dashcam_rec_list_panel, 23);
    lv_obj_set_width(bk_ui->dashcam_rec_list_panel, 197);
    lv_obj_set_height(bk_ui->dashcam_rec_list_panel, 558);
    ...
    lv_obj_set_style_bg_color(bk_ui->dashcam_rec_list_panel, lv_color_hex(0xffffff), LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(bk_ui->dashcam_rec_list_panel, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(bk_ui->dashcam_rec_list_panel, LV_GRAD_DIR_NONE, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(bk_ui->dashcam_rec_list_panel, lv_color_hex(0xffffff), LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(bk_ui->dashcam_rec_list_panel, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(bk_ui->dashcam_rec_list_panel, 255, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(bk_ui->dashcam_rec_list_panel, LV_BORDER_SIDE_FULL, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(bk_ui->dashcam_rec_list_panel, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(bk_ui->dashcam_rec_list_panel, false, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->dashcam_list_title, 8);
    lv_obj_set_y(bk_ui->dashcam_list_title, 4);
    lv_obj_set_width(bk_ui->dashcam_list_title, 181);
    lv_obj_set_height(bk_ui->dashcam_list_title, 20);
    ...
    lv_obj_set_style_text_font(bk_ui->dashcam_list_title, &lv_font_montserrat_regular_12, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_y(bk_ui->dashcam_rec_list, 28);
    lv_obj_set_width(bk_ui->dashcam_rec_list, 195);
    lv_obj_set_height(bk_ui->dashcam_rec_list, 529);
