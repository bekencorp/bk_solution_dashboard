...
void init_page_ota_update(bk_lv_ui_t *bk_ui)
{
    ...
    lv_obj_set_size(bk_ui->ota_update, 1024, 600);
    ...
    lv_obj_set_width(bk_ui->ota_update_bg_img, 1024);
    lv_obj_set_height(bk_ui->ota_update_bg_img, 600);
    ...
    lv_obj_set_x(bk_ui->ota_update_top_bar, 24);
    lv_obj_set_y(bk_ui->ota_update_top_bar, 18);
    lv_obj_set_width(bk_ui->ota_update_top_bar, 976);
    lv_obj_set_height(bk_ui->ota_update_top_bar, 52);
    ...
    lv_obj_set_style_bg_color(bk_ui->ota_update_top_bar, lv_color_hex(0xffffff), LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(bk_ui->ota_update_top_bar, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(bk_ui->ota_update_top_bar, LV_GRAD_DIR_NONE, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(bk_ui->ota_update_top_bar, lv_color_hex(0xffffff), LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(bk_ui->ota_update_top_bar, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(bk_ui->ota_update_top_bar, 255, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(bk_ui->ota_update_top_bar, LV_BORDER_SIDE_FULL, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(bk_ui->ota_update_top_bar, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(bk_ui->ota_update_top_bar, false, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->ota_update_ota_title, 40);
    lv_obj_set_y(bk_ui->ota_update_ota_title, 10);
    lv_obj_set_width(bk_ui->ota_update_ota_title, 120);
    lv_obj_set_height(bk_ui->ota_update_ota_title, 20);
    ...
    lv_imgbtn_set_src(bk_ui->ota_update_back_btn, LV_IMGBTN_STATE_RELEASED, NULL, &nav_ic_back_status_copy_26x26_RGB565A8_NONE, NULL);
    lv_imgbtn_set_src(bk_ui->ota_update_back_btn, LV_IMGBTN_STATE_PRESSED, NULL, &nav_ic_back_status_copy_26x26_RGB565A8_NONE, NULL);
    lv_obj_set_x(bk_ui->ota_update_back_btn, 8);
    lv_obj_set_y(bk_ui->ota_update_back_btn, 13);
    lv_obj_set_width(bk_ui->ota_update_back_btn, 26);
    lv_obj_set_height(bk_ui->ota_update_back_btn, 26);
    ...
    lv_obj_set_x(bk_ui->ota_update_icons_panel, 288);
    lv_obj_set_y(bk_ui->ota_update_icons_panel, 11);
    lv_obj_set_width(bk_ui->ota_update_icons_panel, 400);
    lv_obj_set_height(bk_ui->ota_update_icons_panel, 28);
    ...
    lv_obj_set_style_bg_color(bk_ui->ota_update_icons_panel, lv_color_hex(0xffffff), LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(bk_ui->ota_update_icons_panel, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(bk_ui->ota_update_icons_panel, LV_GRAD_DIR_NONE, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(bk_ui->ota_update_icons_panel, lv_color_hex(0xffffff), LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(bk_ui->ota_update_icons_panel, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(bk_ui->ota_update_icons_panel, 255, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(bk_ui->ota_update_icons_panel, LV_BORDER_SIDE_FULL, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(bk_ui->ota_update_icons_panel, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(bk_ui->ota_update_icons_panel, false, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);

    bk_ui->ota_update_ic_abs = lv_image_create(bk_ui->ota_update_icons_panel);
    lv_image_set_src(bk_ui->ota_update_ic_abs, &nav_ic_abs_26x26_RGB565A8_NONE);
    ...
    lv_obj_set_width(bk_ui->ota_update_ic_abs, 26);
    lv_obj_set_height(bk_ui->ota_update_ic_abs, 26);
    ...
    lv_image_set_src(bk_ui->ota_update_ic_tcs, &nav_ic_tcs_26x26_RGB565A8_NONE);
    ...
    lv_obj_set_width(bk_ui->ota_update_ic_tcs, 26);
    lv_obj_set_height(bk_ui->ota_update_ic_tcs, 26);
    ...
    lv_image_set_src(bk_ui->ota_update_ic_gps, &nav_ic_gps_26x26_RGB565A8_NONE);
    ...
    lv_obj_set_width(bk_ui->ota_update_ic_gps, 26);
    lv_obj_set_height(bk_ui->ota_update_ic_gps, 26);
    ...
    lv_image_set_src(bk_ui->ota_update_ic_bt, &nav_ic_bt_26x26_RGB565A8_NONE);
    ...
    lv_obj_set_width(bk_ui->ota_update_ic_bt, 26);
    lv_obj_set_height(bk_ui->ota_update_ic_bt, 26);
    ...
    lv_image_set_src(bk_ui->ota_update_ic_light, &nav_ic_light_26x26_RGB565A8_NONE);
    ...
    lv_obj_set_width(bk_ui->ota_update_ic_light, 26);
    lv_obj_set_height(bk_ui->ota_update_ic_light, 26);
    ...
    lv_image_set_src(bk_ui->ota_update_ic_eng, &nav_ic_eng_26x26_RGB565A8_NONE);
    ...
    lv_obj_set_width(bk_ui->ota_update_ic_eng, 26);
    lv_obj_set_height(bk_ui->ota_update_ic_eng, 26);
    ...
    lv_image_set_src(bk_ui->ota_update_ic_warn, &nav_ic_warn_26x26_RGB565A8_NONE);
    ...
    lv_obj_set_width(bk_ui->ota_update_ic_warn, 26);
    lv_obj_set_height(bk_ui->ota_update_ic_warn, 26);
    ...
    lv_image_set_src(bk_ui->ota_update_ic_batt, &nav_ic_batt_26x26_RGB565A8_NONE);
    ...
    lv_obj_set_width(bk_ui->ota_update_ic_batt, 26);
    lv_obj_set_height(bk_ui->ota_update_ic_batt, 26);
    ...
    lv_image_set_src(bk_ui->ota_update_ic_tire, &nav_ic_tire_26x26_RGB565A8_NONE);
    ...
    lv_obj_set_width(bk_ui->ota_update_ic_tire, 26);
    lv_obj_set_height(bk_ui->ota_update_ic_tire, 26);
    ...
    lv_image_set_src(bk_ui->ota_update_ic_temp, &nav_ic_temp_copy_26x26_RGB565A8_NONE);
    ...
    lv_obj_set_width(bk_ui->ota_update_ic_temp, 26);
    lv_obj_set_height(bk_ui->ota_update_ic_temp, 26);
    ...
    lv_obj_set_x(bk_ui->ota_update_time_clk, 812);
    lv_obj_set_y(bk_ui->ota_update_time_clk, 10);
    lv_obj_set_width(bk_ui->ota_update_time_clk, 140);
    lv_obj_set_height(bk_ui->ota_update_time_clk, 32);
    ...
    lv_obj_set_x(bk_ui->ota_update_gauge_panel, 250);
    lv_obj_set_y(bk_ui->ota_update_gauge_panel, 117);
    lv_obj_set_width(bk_ui->ota_update_gauge_panel, 520);
    lv_obj_set_height(bk_ui->ota_update_gauge_panel, 380);
    ...
    lv_obj_set_style_bg_color(bk_ui->ota_update_gauge_panel, lv_color_hex(0xffffff), LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(bk_ui->ota_update_gauge_panel, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(bk_ui->ota_update_gauge_panel, LV_GRAD_DIR_NONE, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(bk_ui->ota_update_gauge_panel, lv_color_hex(0xffffff), LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(bk_ui->ota_update_gauge_panel, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(bk_ui->ota_update_gauge_panel, 255, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(bk_ui->ota_update_gauge_panel, LV_BORDER_SIDE_FULL, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(bk_ui->ota_update_gauge_panel, 0, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(bk_ui->ota_update_gauge_panel, false, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->ota_update_prog_ring, 10);
    lv_obj_set_y(bk_ui->ota_update_prog_ring, 66);
    lv_obj_set_width(bk_ui->ota_update_prog_ring, 512);
    lv_obj_set_height(bk_ui->ota_update_prog_ring, 512);
    ...
    lv_obj_set_x(bk_ui->ota_update_pct_num, 8);
    lv_obj_set_y(bk_ui->ota_update_pct_num, 153);
    lv_obj_set_width(bk_ui->ota_update_pct_num, 520);
    lv_obj_set_height(bk_ui->ota_update_pct_num, 80);
    ...
    lv_obj_set_style_text_font(bk_ui->ota_update_pct_num, &lv_font_pingfang_SC_45, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->ota_update_pct_sym, 74);
    lv_obj_set_y(bk_ui->ota_update_pct_sym, 218);
    lv_obj_set_width(bk_ui->ota_update_pct_sym, 520);
    lv_obj_set_height(bk_ui->ota_update_pct_sym, 28);
    ...
    lv_obj_set_x(bk_ui->ota_update_stat_lbl, 8);
    lv_obj_set_y(bk_ui->ota_update_stat_lbl, 260);
    lv_obj_set_width(bk_ui->ota_update_stat_lbl, 520);
    lv_obj_set_height(bk_ui->ota_update_stat_lbl, 32);
    ...
    lv_obj_set_x(bk_ui->ota_update_eta_lbl, 8);
    lv_obj_set_y(bk_ui->ota_update_eta_lbl, 294);
    lv_obj_set_width(bk_ui->ota_update_eta_lbl, 520);
    lv_obj_set_height(bk_ui->ota_update_eta_lbl, 28);
