...
{
    klok_h264_pp_osd_use_music_overlay(enable);
}
...
{
    klok_lvgl_preview_release_locked();
    return klok_h264_pp_osd_enter_pp_locked();
}
...
{
    return klok_h264_pp_osd_is_pp_active();
}
...
{
    klok_h264_pp_osd_set_music_pose(angle_index, offset_y);
}
