...
static void home_bt_card_event_cb(lv_event_t *e)
{
...
void init_page_home(bk_lv_ui_t *bk_ui)
{
    ...
    lv_obj_remove_flag(bk_ui->home_bt_card, LV_OBJ_FLAG_SCROLL_CHAIN_HOR | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_CHAIN | LV_OBJ_FLAG_SNAPPABLE | LV_OBJ_FLAG_SCROLL_CHAIN_VER | LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_SCROLL_WITH_ARROW | LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_GESTURE_BUBBLE | LV_OBJ_FLAG_SCROLL_MOMENTUM);
    lv_obj_add_flag(bk_ui->home_bt_card, LV_OBJ_FLAG_CLICKABLE);
    lv_obj_add_event_cb(bk_ui->home_bt_card, home_bt_card_event_cb, LV_EVENT_CLICKED, NULL);
