...
void init_page_klok_main(bk_lv_ui_t *bk_ui)
{
    ...
    lv_obj_set_y(bk_ui->klok_main_km_back, 20);
    lv_obj_set_width(bk_ui->klok_main_km_back, 220);
    lv_obj_set_height(bk_ui->klok_main_km_back, 68);
    ...
    lv_obj_set_style_pad_top(bk_ui->klok_main_km_back, 18, LV_PART_MAIN | LV_STATE_DEFAULT);
