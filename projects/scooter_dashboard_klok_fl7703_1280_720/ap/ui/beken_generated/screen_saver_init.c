...
static void screen_saver_back_event_cb(lv_event_t *e)
{
...
void init_page_screen_saver(bk_lv_ui_t *bk_ui)
{
    ...
    lv_obj_set_y(bk_ui->screen_saver_ss_back, 20);
    lv_obj_set_width(bk_ui->screen_saver_ss_back, 230);
    lv_obj_set_height(bk_ui->screen_saver_ss_back, 68);
    ...
    lv_obj_add_flag(bk_ui->screen_saver_ss_back, LV_OBJ_FLAG_CLICKABLE);
    lv_obj_add_event_cb(bk_ui->screen_saver_ss_back,
                        screen_saver_back_event_cb,
                        LV_EVENT_CLICKED,
                        NULL);
    ...
    lv_obj_set_style_pad_top(bk_ui->screen_saver_ss_back, 18, LV_PART_MAIN | LV_STATE_DEFAULT);
