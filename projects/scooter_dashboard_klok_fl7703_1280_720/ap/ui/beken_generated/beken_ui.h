...
typedef struct
{
    ...
    /* Page: music_player (hand-authored in this target generated directory). */
    lv_obj_t *music_player;
    lv_obj_t *music_player_back;
    lv_obj_t *music_player_bt_tab;
    lv_obj_t *music_player_usb_tab;
    lv_obj_t *music_player_bt_panel;
    lv_obj_t *music_player_bt_status;
    lv_obj_t *music_player_bt_title_magenta;
    lv_obj_t *music_player_bt_title_cyan;
    lv_obj_t *music_player_bt_title;
    lv_obj_t *music_player_bt_artist;
    lv_obj_t *music_player_bt_play;
    lv_obj_t *music_player_usb_panel;
    lv_obj_t *music_player_usb_title;
    lv_obj_t *music_player_usb_artist;
    lv_obj_t *music_player_usb_play;
    lv_obj_t *music_player_usb_list;
} bk_lv_ui_t;
