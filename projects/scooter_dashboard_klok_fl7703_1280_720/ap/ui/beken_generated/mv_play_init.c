...
void init_page_mv_play(bk_lv_ui_t *bk_ui)
{
    ...
    lv_obj_set_x(bk_ui->mv_play_back_btn, 20);
    lv_obj_set_y(bk_ui->mv_play_back_btn, 9);
    lv_obj_set_width(bk_ui->mv_play_back_btn, 120);
    lv_obj_set_height(bk_ui->mv_play_back_btn, 64);
