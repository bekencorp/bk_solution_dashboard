...
/*
 * Set while the preloader owns the shared SD mount. boot_avi_play() checks this
 * to avoid mounting the same volume a second time with a different FATFS object.
 */
