...
/*
 * The preloader relies on LVGL's TJPGD software decoder. Projects whose lv_conf
 * leaves LV_USE_TJPGD off (e.g. scooter_1280_720) get no-op stubs below; only
 * projects that enable it (scooter_1280_720_v2) actually call these anyway.
 */
#if LV_USE_TJPGD
...
#else /* !LV_USE_TJPGD: preloader unavailable, provide stubs */
