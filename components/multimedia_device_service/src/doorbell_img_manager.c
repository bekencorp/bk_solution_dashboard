...
#define FRAME_SIZE_DEFAULT  (1024 * 200)
    ...
    defined(CONFIG_BK_ENCODER_H264_MAX_OUTPUT_BUFFER)
#if CONFIG_BK_ENCODER_MJPEG_MAX_OUTPUT_BUFFER > CONFIG_BK_ENCODER_H264_MAX_OUTPUT_BUFFER
#define FRAME_SIZE  CONFIG_BK_ENCODER_MJPEG_MAX_OUTPUT_BUFFER
#else
#define FRAME_SIZE  CONFIG_BK_ENCODER_H264_MAX_OUTPUT_BUFFER
#endif
#elif defined(CONFIG_BK_ENCODER_MJPEG_MAX_OUTPUT_BUFFER)
#define FRAME_SIZE  CONFIG_BK_ENCODER_MJPEG_MAX_OUTPUT_BUFFER
