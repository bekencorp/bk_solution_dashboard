...
void cli_avdk_doorbell_isp_cmd(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
...
void cli_avdk_doorbell_display_cmd(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
    avdk_err_t ret = AVDK_ERR_GENERIC;
...
void cli_avdk_doorbell_cmd(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
