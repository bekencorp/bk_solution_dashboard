...
avdk_err_t doorbell_decode_register_isr_callback(void (*callback)(uint32_t wr_cnt, void *arg), void *arg, decode_test_port_t port);

avdk_err_t doorbell_decode_register_notify_callback(void (*notify)(void *arg), void *arg, decode_test_port_t port);

avdk_err_t doorbell_decode_gpu_set_rd_cnt(uint32_t wr_cnt);
avdk_err_t doorbell_decode_h264e_set_rd_cnt(uint32_t wr_cnt);
 ...
 */
avdk_err_t doorbell_decode_signal_frame_done(decode_test_port_t port);
 ...
 */
avdk_err_t doorbell_decode_set_port_rd_cnt(decode_test_port_t port, uint32_t rd_cnt);
